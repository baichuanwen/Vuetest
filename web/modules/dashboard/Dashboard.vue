            ...
            <b-row>
                <b-col sm="12" lg="4">
                    ...
                    <ul class="horizontal-bars">
                        ...
                        <li class="legend">
                            <b-badge pill variant="info"></b-badge> <small>New clients</small> &nbsp;
                            <b-badge pill variant="danger"></b-badge> <small>Recurring clients</small>
                        </li>
                    </ul>
                </b-col>
                <b-col sm="6" lg="4">
...
<script>
    import CardLine1ChartExample from './example/CardLine1ChartExample'
    import CardLine2ChartExample from './example/CardLine2ChartExample'
    import CardLine3ChartExample from './example/CardLine3ChartExample'
    import CardBarChartExample from './example/CardBarChartExample'
    import MainChartExample from './example/MainChartExample'
    import SocialBoxChartExample from './example/SocialBoxChartExample'
    import CalloutChartExample from './example/CalloutChartExample'
    import {
        Callout
